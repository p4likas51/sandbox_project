...
namespace Game
{
    internal partial class Program
    {
        public static int WcJatek()
        {
            ...
            int JatekKezdete()
            {
                string szoveg = "Ha eléred az 500 pontot akkor sikeres a dolgod!";
                string[] valasztasok = {"Játék"};
            ...
            int JatekVege()
            {
                string szoveg = "Vége a játéknak";
                szoveg += $"\nElért pontszám: {score}";
                string[] valasztasok = {"Vége"};
                int valasztottIndex = Menu(szoveg, valasztasok);
                keepPlaying = false;
                return valasztottIndex;
            }
